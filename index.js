...
const serviceAccount = JSON.parse(MDB_FIREBASE);
...
const uri = `mongodb+srv://${MDB_USER}:${MDB_PASSWORD}@cluster0.xztta.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
